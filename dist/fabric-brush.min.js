...
!function(s){s.SprayBrush=s.util.createClass(s.BaseBrush,{color:"#000000",opacity:1,width:30,_baseWidth:40,_drips:[],_dripThreshold:15,_inkAmount:0,_interval:20,_lastPoint:null,_point:null,_strokeId:0,brush:null,
...
!function(n){n.util.getRandom=function(n,t){return t=t||0,Math.random()*((n||1)-t)+t},n.util.clamp=function(n,t,u){return"number"!=typeof u&&(u=0),n>t?t:n<u?u:n}}(fabric);
},{}]},{},[1,2,3,4,5,6,7,8])
